...
public:
    ...
    static uint32 GetStaticMeshCount(UStaticMesh* staticMesh) { return staticMeshCountsMap[staticMesh]; }
...
private:
    ...
    inline static TMap< UStaticMesh*, uint32> staticMeshCountsMap;
